...
<header>
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #006400;">
    <a class="navbar-brand" href="/jesus/index.php" style="font-weight:bold !important; font-size: 32px; font-family: 'Roboto', sans-serif"> <img src="/jesus/assets/images/ID.png" width="40px" height="" alt="">&nbsp; DigitalL</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="/jesus/pages/teste1/index.php">Sobre o Projeto</a>
          </div>
        </li>
      </ul>
    </div>
